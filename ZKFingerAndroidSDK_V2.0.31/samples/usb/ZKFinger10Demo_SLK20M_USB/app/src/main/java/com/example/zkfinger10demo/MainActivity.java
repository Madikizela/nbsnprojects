...
public class MainActivity extends AppCompatActivity {
    ...
    private void createFingerprintSensor()
    {
        ...
        fingerprintSensor = FingerprintFactory.createFingerprintSensor(getApplicationContext(), TransportType.USB, deviceParams);
    }
    ...
    private boolean enumSensor()
    {
        ...
        for (UsbDevice device : usbManager.getDeviceList().values()) {
            ...
            if (device_vid == ZKTECO_VID && device_pid == LIVE20M_PID)
            {
                usb_pid = device_pid;
                return true;
            }
