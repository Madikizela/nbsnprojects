...
class _UnitStandardsScreenState extends State<UnitStandardsScreen> {
                ...
                if (qual['unitStandards'] != null) {
                  for (int i = 0; i < qual['unitStandards'].length; i++) {
                    ...
                    if (i > 0) {
                      ...
                      // RELAXED: Unlock if summative is completed OR if both are completed
                      ...
                      isAccessible = previousProgress != null &&
                          (previousProgress['summativeCompleted'] == true ||
                              (previousProgress['formativeCompleted'] == true &&
                                  previousProgress['summativeCompleted'] ==
                                      true));
                    }
  ...
  void _selectUnitStandard(dynamic unitStandard) {
    ...
    context
        ...
        .then((_) {
      // Refresh unit standards when returning from assessments
      fetchUnitStandards();
    });
  }
