...
async function createCompleteSchema() {
  try {
    ...
    await pool.query(`
      ...
      ADD CONSTRAINT IF NOT EXISTS "FK_SkillsDevelopmentProviders_Clients_ClientId" 
      FOREIGN KEY ("ClientId") REFERENCES "Clients" ("Id") ON DELETE CASCADE;
    `);
    
    await pool.query(`
      ALTER TABLE "Departments" 
      ADD CONSTRAINT IF NOT EXISTS "FK_Departments_SkillsDevelopmentProviders_SkillsDevelopmentProviderId" 
      FOREIGN KEY ("SkillsDevelopmentProviderId") REFERENCES "SkillsDevelopmentProviders" ("Id") ON DELETE CASCADE;
    `);
    
    await pool.query(`
      ALTER TABLE "Users" 
      ADD CONSTRAINT IF NOT EXISTS "FK_Users_Clients_ClientId" 
      FOREIGN KEY ("ClientId") REFERENCES "Clients" ("Id");
    `);
    
    await pool.query(`
      ALTER TABLE "Users" 
      ADD CONSTRAINT IF NOT EXISTS "FK_Users_SkillsDevelopmentProviders_SkillsDevelopmentProviderId" 
      FOREIGN KEY ("SkillsDevelopmentProviderId") REFERENCES "SkillsDevelopmentProviders" ("Id");
    `);
    
    await pool.query(`
      ALTER TABLE "Users" 
      ADD CONSTRAINT IF NOT EXISTS "FK_Users_Departments_DepartmentId" 
