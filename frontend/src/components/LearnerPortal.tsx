      ...
      <nav style={{ position: 'sticky', top: 0, zIndex: 100, background: '#1e293b', padding: '12px 24px', borderBottom: '1px solid #334155' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
            ...
            <span style={{ fontWeight: 700, fontSize: 18, whiteSpace: 'nowrap' }}>SDP Portal</span>
    ...
    <div style={{ width: '100vw', height: '100vh', display: 'flex', overflow: 'hidden', fontFamily: "'Segoe UI', system-ui, sans-serif" }}>
      ...
      <div className="l-left" style={{
        ...
        <div style={{ textAlign:'center', marginBottom:48, animation:'learnerFloat 4s ease-in-out infinite' }}>
          ...
          <p style={{ color:'rgba(255,255,255,0.85)', fontSize:14, fontWeight:600, margin:'0', letterSpacing: 0.3 }}>Skills Development &amp; Training</p>
        </div>
        ...
        <p style={{ position:'absolute', bottom:24, color:'rgba(255,255,255,0.3)', fontSize:12, textAlign:'center' }}>
          Skills Development &amp; Training<br />© {new Date().getFullYear()} SDP Portal
        </p>
      </div>
      ...
      <div className="l-right" style={{
        ...
        <div style={{ width:'100%', maxWidth:420, animation:'learnerFadeIn 0.5s ease' }}>
          ...
          <p style={{ textAlign:'center', color:'#94a3b8', fontSize:12, marginTop:32 }}>
            SDP Portal · Skills Development &amp; Training<br />
